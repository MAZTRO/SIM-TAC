...
(function() {
    ...
    var COLORS = {};
    COLORS["color-brand"] = "#EEFF0A";
    COLORS["color-gull-gray"] = "#9db2bd";
    COLORS["color-scooter"] = "#38acdb";
    COLORS["color-curious-blue"] = "#4EFF16";
    var TradingView = {
    ...
    TradingView.WidgetAbstract.prototype = {
        ...
        addWrapperFrame: function(widgetCode, logoCode, widgetBgColor) {
            ...
            return '<div id="test_chart" style="' + "position: relative;" + "box-sizing: content-box;" + "width: " + width + ";" + "height: " + height + ";" + "margin: 0 auto !important;" + "padding: 0 !important;" + "font-family:Arial,sans-serif;" + '">' + '<div style="' + "width: " + width + ";" + "height: " + height + ";" + "background: " + widgetBgColor + ";" + "padding: 0 !important;" + '">' + widgetCode + "</div>" + (logoCode || "") + "</div>"
        },
        addFooterLogo: function(widgetCode, options) {
            var greyText = (options || {}).greyText || "SIM-TAC";
            var linkText = (options || {}).linkText || "SIM-TAC.com";
            var href = (options || {}).href || "https://www.sim-tac.com/";
            console.log(widgetCode);
            
            return TradingView.WidgetAbstract.prototype.addWrapperFrame.call(this, widgetCode, '<div style="' + "position:absolute;" + "display: hiden;" + "box-sizing: content-box;" + "height: 50px;" + "width: " + TradingView.WidgetAbstract.prototype.width.call(this) + ";" + "bottom: 0;" + "left: 0;" + "margin: 0;" + "padding: 0;" + "font-family: Arial,sans-serif;" + '">' + '<div style="' + "display: hiden;" + "margin: 0 1px 1px 1px;" + "line-height: 7px;" + "box-sizing: content-box;" + "height: 11px;" + "padding: 6px 10px;" + "text-align: right;" + "background: #fff;" + '">' + "<a" + ' href="' + href + "?" + TradingView.generateUtmForUrlParams(this.options) + '"' + ' target="_blank"' + ' style="' + "color: #0099d4;" + "text-decoration: none;" + "font-size: 101px;" + '"' + ">" + '<span style="' + "color: #b4b4b4;" + "font-size: 101px;" + '">' + greyText + "</span> " + linkText + "</a>" + "</div>" + "</div>", "#222")
        }
    };
